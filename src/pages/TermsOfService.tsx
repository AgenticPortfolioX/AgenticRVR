...
export default function TermsOfService() {
  useSEO('Terms of Service', 'Terms of Service for Agentic Services.');
      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <div className="prose prose-invert max-w-none text-zinc-400 space-y-6">
            ...
            <p>
              Permission is granted to temporarily download one copy of the materials (information or software) on Agentic Services' website for personal, non-commercial transitory viewing only.
            </p>
            <p>This is the grant of a license, not a transfer of title, and under this license you may not:</p>
            <ul className="list-disc pl-6 space-y-2">
              <li>modify or copy the materials;</li>
              <li>use the materials for any commercial purpose, or for any public display (commercial or non-commercial);</li>
              <li>attempt to decompile or reverse engineer any software contained on Agentic Services' website;</li>
            ...
            <p>
              The materials on Agentic Services' website are provided on an 'as is' basis. Agentic Services makes no warranties, expressed or implied, and hereby disclaims and negates all other warranties including, without limitation, implied warranties or conditions of merchantability, fitness for a particular purpose, or non-infringement of intellectual property or other violation of rights.
            </p>

            <h2 className="text-2xl font-medium text-white mt-12 mb-4">4. Limitations</h2>
            <p>
              In no event shall Agentic Services or its suppliers be liable for any damages (including, without limitation, damages for loss of data or profit, or due to business interruption) arising out of the use or inability to use the materials on Agentic Services' website, even if Agentic Services or a Agentic Services authorized representative has been notified orally or in writing of the possibility of such damage.
            </p>
