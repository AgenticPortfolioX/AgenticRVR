...
export default function AMPDemo() {
  useSEO(
    ...
    'Take a photo and watch it get cryptographically signed, device-key registered on Base Sepolia, and verified via Chainlink — the full 6-phase Deepfake Slayer pipeline.',
  );
