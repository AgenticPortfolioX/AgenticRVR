...
export default function TermsOfService() {
  useSEO('Terms of Service', 'Terms of Service for RVR LLC.');
      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <div className="prose prose-invert max-w-none text-zinc-400 space-y-6">
            ...
            <p>
              Permission is granted to temporarily download one copy of the materials (information or software) on RVR LLC's website for personal, non-commercial transitory viewing only.
            </p>
            <p>This is the grant of a license, not a transfer of title, and under this license you may not:</p>
            <ul className="list-disc pl-6 space-y-2">
              <li>modify or copy the materials;</li>
              <li>use the materials for any commercial purpose, or for any public display (commercial or non-commercial);</li>
              <li>attempt to decompile or reverse engineer any software contained on RVR LLC's website;</li>
            ...
            <p>
              The materials on RVR LLC's website are provided on an 'as is' basis. RVR LLC makes no warranties, expressed or implied, and hereby disclaims and negates all other warranties including, without limitation, implied warranties or conditions of merchantability, fitness for a particular purpose, or non-infringement of intellectual property or other violation of rights.
            </p>

            <h2 className="text-2xl font-medium text-white mt-12 mb-4">4. Limitations</h2>
            <p>
              In no event shall RVR LLC or its suppliers be liable for any damages (including, without limitation, damages for loss of data or profit, or due to business interruption) arising out of the use or inability to use the materials on RVR LLC's website, even if RVR LLC or a RVR LLC authorized representative has been notified orally or in writing of the possibility of such damage.
            </p>

            <h2 className="text-2xl font-medium text-white mt-12 mb-4">5. Revisions and Errata</h2>
            <p>
              The materials appearing on RVR LLC's website could include technical, typographical, or photographic errors. RVR LLC does not warrant that any of the materials on its website are accurate, complete, or current. RVR LLC may make changes to the materials contained on its website at any time without notice.
            </p>

            <h2 className="text-2xl font-medium text-white mt-12 mb-4">6. SMS Communications</h2>
            <p className="mb-4">
              By opting in to receive SMS text messages from RVR LLC, you agree to receive recurring automated promotional and personalized marketing text messages (e.g., appointment reminders, service updates) from us.
            </p>
