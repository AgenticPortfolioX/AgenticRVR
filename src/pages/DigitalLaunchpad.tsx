    ...
    <div className="pt-24 pb-16 px-6 min-h-screen bg-[#050505] selection:bg-orange-500/30">
      <div className="max-w-7xl mx-auto">
        ...
        <section className="mb-16">
          ...
          >
            <h3 className="text-2xl font-bold text-white mb-4">Stackable Backend Automations</h3>
            <p className="text-zinc-400 mb-8 max-w-2xl">
              Once your site is generating leads, you can stack battle-tested AI agents—like Speed-to-Lead, Automated Review Engines, and more—that run 24/7 without any extra lift on your part.
            </p>
            <Link 
              to="/managed-services"
